...
Cfg.cfgfile = os.path.join(_BASE_DIR, 'cfg', 'yolov4-kfood.cfg')
...
Cfg.max_batches = 300000
Cfg.steps = [240000, 270000]
...
Cfg.train_label = os.path.join(_BASE_DIR, 'data', 'train_od.txt')
Cfg.val_label = os.path.join(_BASE_DIR, 'data','test_od.txt')
